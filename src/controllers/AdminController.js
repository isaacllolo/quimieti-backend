...
export default {
  ...
  editarTema: { ruta: '/admin/temas/:id', metodo: 'put', controlador: editarTema },
  eliminarTema: { ruta: '/admin/temas/:id', metodo: 'delete', controlador: eliminarTema },
  agregarLeccion: { ruta: '/admin/lecciones', metodo: 'post', controlador: agregarLeccion },
  editarLeccion: { ruta: '/admin/lecciones/:id', metodo: 'put', controlador: editarLeccion },
  eliminarLeccion: { ruta: '/admin/lecciones/:id', metodo: 'delete', controlador: eliminarLeccion },
  agregarQuiz: { ruta: '/admin/quizzes', metodo: 'post', controlador: agregarQuiz },
  editarQuiz: { ruta: '/admin/quizzes/:id', metodo: 'put', controlador: editarQuiz },
  eliminarQuiz: { ruta: '/admin/quizzes/:id', metodo: 'delete', controlador: eliminarQuiz },
  agregarSlide: { ruta: '/admin/slides', metodo: 'post', controlador: agregarSlide },
  editarSlide: { ruta: '/admin/slides/:id', metodo: 'put', controlador: editarSlide },
  eliminarSlide: { ruta: '/admin/slides/:id', metodo: 'delete', controlador: eliminarSlide },
